...
################################################################
# This is a generated script based on design: GULF_Eval_Board
#
...
# source GULF_Eval_Board_script.tcl
...
set design_name GULF_Eval_Board
...
proc create_root_design { parentCell } {
  ...
  set read_error_0 [ create_bd_port -dir I -from 1 -to 0 read_error_0 ]
  set read_roll_0 [ create_bd_port -dir I -from 31 -to 0 read_roll_0 ]
  set requst_addr_0 [ create_bd_port -dir O -from 6 -to 0 requst_addr_0 ]
  set responds_data_0 [ create_bd_port -dir I -from 31 -to 0 responds_data_0 ]
  set write_addr_0 [ create_bd_port -dir O -from 6 -to 0 write_addr_0 ]
  set write_data_0 [ create_bd_port -dir O -from 31 -to 0 write_data_0 ]
  set write_error_0 [ create_bd_port -dir O -from 1 -to 0 write_error_0 ]
  set write_roll_0 [ create_bd_port -dir O -from 31 -to 0 write_roll_0 ]

  # Create instance: axi_data_transfer_1, and set properties
  set axi_data_transfer_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_data_transfer:3.0 axi_data_transfer_1 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_data_transfer_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_net -net axi_data_transfer_1_requst_addr [get_bd_ports requst_addr_0] [get_bd_pins axi_data_transfer_1/requst_addr]
  connect_bd_net -net axi_data_transfer_1_write_addr [get_bd_ports write_addr_0] [get_bd_pins axi_data_transfer_1/write_addr]
  connect_bd_net -net axi_data_transfer_1_write_data [get_bd_ports write_data_0] [get_bd_pins axi_data_transfer_1/write_data]
  connect_bd_net -net axi_data_transfer_1_write_error [get_bd_ports write_error_0] [get_bd_pins axi_data_transfer_1/write_error]
  connect_bd_net -net axi_data_transfer_1_write_roll [get_bd_ports write_roll_0] [get_bd_pins axi_data_transfer_1/write_roll]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports gpio_io_o_0] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK0_0] [get_bd_pins axi_data_transfer_1/s00_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net read_error_0_1 [get_bd_ports read_error_0] [get_bd_pins axi_data_transfer_1/read_error]
  connect_bd_net -net read_roll_0_1 [get_bd_ports read_roll_0] [get_bd_pins axi_data_transfer_1/read_roll]
  connect_bd_net -net responds_data_0_1 [get_bd_ports responds_data_0] [get_bd_pins axi_data_transfer_1/responds_data]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_data_transfer_1/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_data_transfer_1/S00_AXI/S00_AXI_reg] SEG_axi_data_transfer_1_S00_AXI_reg

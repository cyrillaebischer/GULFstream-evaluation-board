...
HD_PWD='C:/Users/Cyrill/Documents/S6/BA-GULFstream/Final/gulfstream-evaluation-board/FW_SW_Test/FW_SW_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GULF_Eval_Board_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GULF_Eval_Board_top.tcl -notrace

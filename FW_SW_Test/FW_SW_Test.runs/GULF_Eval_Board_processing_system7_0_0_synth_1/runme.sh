...
HD_PWD='C:/Users/julie/Desktop/git/Bachelor/GULF_Eval_Board/GULF_Eval_Board.runs/GULF_Eval_Board_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GULF_Eval_Board_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GULF_Eval_Board_processing_system7_0_0.tcl
